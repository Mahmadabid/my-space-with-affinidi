  ...
  return (
    <div className="my-2 mx-2">
      <div className="mx-auto bg-sky-50 my-3 px-4 py-6 rounded-lg shadow-md max-w-lg">
        ...
        <p className="mb-4">But wait, there's more! My Space also includes a banking feature. You can send money to anyone and use your bank account to purchase items in <Link href="https://pixels-market.vercel.app/" className="text-blue-500 font-medium">Pixel Market</Link>.</p>
      </div>
      <div className="flex flex-wrap justify-center space-x-7 items-center">
        <div className="bg-teal-100 my-3 px-4 py-6 rounded-lg shadow-md min-w-64 max-w-96">
          ...
          <p className="mb-4">The Pixel Bank allows you to send money to your friends, family and other people. It also allows you to buy stuff directly from <Link href="https://pixels-market.vercel.app/" className="text-blue-500 font-medium">Pixel Market</Link>. You also get a signup bonus.</p>
